...
describe('generateMarkdown', () => {
    ...
    it('should generate markdown for a single user', () => {
        ...
        expect(result).toContain('| 🥇 | <a href="https://github.com/user1">@user1</a> | 100 |');
    ...
    it('should generate markdown with medals for top 3 users', () => {
        ...
        expect(result).toContain('| 🥇 | <a href="https://github.com/user1">@user1</a> | 300 |');
        expect(result).toContain('| 🥈 | <a href="https://github.com/user2">@user2</a> | 200 |');
        expect(result).toContain('| 🥉 | <a href="https://github.com/user3">@user3</a> | 100 |');
    });
    ...
    it('should generate markdown with numbering for users beyond top 3', () => {
        ...
        expect(result).toContain('| 4 | <a href="https://github.com/user4">@user4</a> | 200 |');
        expect(result).toContain('| 5 | <a href="https://github.com/user5">@user5</a> | 100 |');
    });
