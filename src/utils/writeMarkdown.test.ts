...
describe('writeMarkdown', () => {
    ...
    it('throws error when start marker is not found', () => {
        ...
        expect(() => writeMarkdown(mockPath, mockContent, markers))
            .toThrow(`Markers not found in the file: ${mockPath}. Please check the markers.`);
    });
    ...
    it('throws error when start marker appears after end marker', () => {
        ...
        expect(() => writeMarkdown(mockPath, mockContent, markers))
            .toThrow(`Start marker appears after end marker in the file: ${mockPath}. Please check the markers.`);
    });
    ...
    it('passes through any fs errors', () => {
        ...
        expect(() => writeMarkdown(mockPath, mockContent))
