...
describe('githubService', () => {
    ...
    describe('getRepositoryPullRequests', () => {
        ...
        it('should throw an error when the API call fails', async () => {
            ...
            ).rejects.toThrow('Failed to get pull requests for testowner/testrepo: API error');
        });
    });
    ...
    describe('getRepositoryIssues', () => {
        ...
        it('should throw an error when the API call fails', async () => {
            ...
            ).rejects.toThrow('Failed to get issues for testowner/testrepo: API error');
        });
    });
    ...
    describe('getPullRequestReviews', () => {
        ...
        it('should throw an error when the API call fails', async () => {
            ...
            ).rejects.toThrow('Failed to get reviews for testowner/testrepo: API error');
        });
    });
    ...
    describe('getRepositoryCommits', () => {
        ...
        it('should throw an error when the API call fails', async () => {
            ...
            ).rejects.toThrow('Failed to get commits for testowner/testrepo: API error');
        });
    });
    ...
    describe('getRepositoryComments', () => {
        ...
        it('should throw an error when the API call fails', async () => {
            ...
            ).rejects.toThrow('Failed to get comments for testowner/testrepo: API error');
        });
    });
    ...
    describe('getOrganizationRepositories', () => {
        ...
        it('should throw an error when the API call fails', async () => {
            ...
            ).rejects.toThrow('Failed to get repositories for organization testorg: API error');
        });
    });
});
